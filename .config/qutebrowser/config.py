...
c.colors.keyhint.suffix.fg = xresources['*color7']
...
c.colors.statusbar.caret.fg = xresources['*color4']

# Background color of the statusbar in caret mode.
c.colors.statusbar.caret.bg = xresources['*color0']

# Foreground color of the statusbar in caret mode with a selection.
c.colors.statusbar.caret.selection.fg = xresources['*color4']

# Background color of the statusbar in caret mode with a selection.
c.colors.statusbar.caret.selection.bg = xresources['*color0']

# Background color of the progress bar.
c.colors.statusbar.progress.bg = xresources['*color4']
...
c.colors.statusbar.url.hover.fg = xresources['*color9']
...
c.colors.tabs.pinned.odd.bg = xresources['*color2']
